    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('suggestedPrice', models.DecimalField(blank=True, decimal_places=2, default='', max_digits=100, null=True)),
                ('totalAmountDue', models.DecimalField(blank=True, decimal_places=2, default='', max_digits=100, null=True)),
